...
public class CalisanGorev extends javax.swing.JFrame {
    ...
    private void seansComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_seansComboBoxActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalisanGorev.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalisanGorev().setVisible(true);
            }
        });
    }
